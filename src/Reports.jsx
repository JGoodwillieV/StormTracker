...
import { 
  ...
  TrendingUp, Activity, Users, Target, ArrowRight, Bug
} from 'lucide-react';
...
// --- SUB-COMPONENTS (Logic isolated to ensure reliability) ---
...
const QualifiersReport = ({ onBack }) => {
  ...
  // --- HELPERS (The exact ones that worked) ---
      ...
      <div className="space-y-4">
          <div className="flex items-center justify-between">
              ...
              <div className="flex gap-4 items-center">
                ...
                <select value={selectedStandard} onChange={(e) => setSelectedStandard(e.target.value)} className="bg-white border p-2 rounded-lg text-sm font-bold text-slate-800">
